...
- [#4](https://github.com/polycore/pg-dry-run/pull/4) [`db58cc1`](https://github.com/polycore/pg-dry-run/commit/db58cc10a9821fb815e884655f25ba4248e858cf) Thanks [@kafkas](https://github.com/kafkas)! - No library changes. This release exists because `0.1.0` published to npm without
